      ...
      <div className="App" style={{ backgroundColor: "white", width: "40%", height: "100vh" }}>
        ...
        >
          ...
          <Form.Item>
            ...
            <h4 style={{ color: "purple" }}> Materyal Fiyat: <span>{materialPirceTotal}TL</span></h4>
            <h4 style={{ color: "purple" }}> Materyal Fiyat İle VAT: <span>{taxPriceTotal}TL</span></h4>
            ...
            <h4 style={{ color: "purple" }}>Toplam Fiyat İle gönderi: {totalPriceWithShipment}TL</h4>
