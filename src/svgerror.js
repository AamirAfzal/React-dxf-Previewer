export const svgerror = `<?xml version="1.0"?>
  ...
  <metadata>
    <rdf:RDF>
      <cc:Work>
        ...
        <dc:title>red round error warning icon</dc:title>
        <dc:date>2006-09-07T17:35:55</dc:date>
        <dc:description>a red round error or warning icon</dc:description>
        <dc:source>http://openclipart.org/detail/109/red-round-error-warning-icon-by-molumen</dc:source>
        <dc:creator>
          <cc:Agent>
